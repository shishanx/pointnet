        ...
        def train_one_epoch(train_file_idx, epoch_num):
            ...
            for i in range(num_train_file):
                ...
                for j in range(num_batch):
                    ...
                    feed_dict = {
                            pointclouds_ph: cur_data[begidx: endidx, 0:point_num, ...], 
                            labels_ph: cur_labels[begidx: endidx, ...], 
                            input_label_ph: cur_labels_one_hot[begidx: endidx, 0:point_num, ...], 
                            seg_ph: cur_seg[begidx: endidx, 0:point_num, ...],
                    ...
                    per_instance_part_acc = np.mean(pred_seg_res == cur_seg[begidx: endidx, 0:point_num, ...], axis=1)
